...
const KINDS: { kind: HbType; label: string }[] = [
  { kind: "sw-weapon", label: "Weapons" },
  { kind: "sw-gear", label: "Gear" },
  { kind: "sw-force", label: "Force Powers" },
  { kind: "sw-character", label: "Characters" },
];

export default async function SWHomebrewHubPage() {
    ...
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <header className="mb-8 flex items-end justify-between gap-4 border-b border-[var(--border)] pb-6">
        <div>
          ...
          <p className="mt-1 text-[13px] font-semibold uppercase tracking-[0.25em] text-[var(--sw)] sm:text-[11px] sm:tracking-[0.35em]">
