  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <header className="mb-8 flex items-end justify-between gap-4 border-b border-[var(--border)] pb-6">
        <div>
          <h1 className="font-display text-3xl font-black tracking-wide">My DarkSpace Homebrew</h1>
          <p className="mt-1 text-[13px] font-semibold uppercase tracking-[0.25em] text-[var(--darkspace)] sm:text-[11px] sm:tracking-[0.35em]">
            {total ? `${total} creation${total === 1 ? "" : "s"} across ${KINDS.length} types` : "create and manage all your DarkSpace homebrew"}
          </p>
        </div>
        <Link
          href="/dashboard"
      ...
      <p className="mb-6 max-w-[62ch] text-[13px] leading-relaxed text-[var(--muted)]">
        Everything you make here flows into the DarkSpace reference pages, the character
        sheet, and the GM screen. Share a creation to a campaign to let your table use it too.
      </p>
