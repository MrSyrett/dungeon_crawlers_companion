...
export const DS_SHIP: DsShip = {
  ...
  "classifications": [
    {
      "name": "Explorer",
      "blurb": "Scouts, trailblazers, surveyors, and cartographers — the eyes that chart the endless night.",
      "sysSlots": 8,
      "featSlots": 7,
      "freeComponent": "Sensor Array",
      "hpDie": "d4",
      "features": [
        {
          "name": "Long Range Sensors",
          "text": "While the Sensor Array is online, all DCs for detecting hazards and threats are reduced by 3."
        },
        {
          "name": "Made to Last",
          "text": "Advantage on CON checks to resist damage from hazards and extreme conditions."
        },
        {
          "name": "Starblazer",
          "text": "Astrogation Mishap rolls are made with advantage to determine the outcome."
        }
      ],
      "talents": [
        {
          "r": "2",
          "text": "Auxiliary Protocol. 1/episode, repair a ship system without a check. +1 use if already known."
        },
        {
          "r": "3-6",
          "text": "+1 to HP"
        ...
        {
          "r": "12",
          "text": "Choose an Explorer Talent or +2 points to assign to stats"
        }
      ]
    },
    {
      "name": "Fighter",
      "blurb": "Interceptors, dogfighters, escorts, and strikers — the razor's edge of fleet combat.",
      "sysSlots": 10,
      "featSlots": 3,
      "freeComponent": "Weapons Array + 1 Light Weapon",
      "hpDie": "d6",
      "features": [
        {
          "name": "Dogfighting",
          "text": "+1 to attack and damage against a target within CLOSE range."
        },
        {
          "name": "Intercept Speed",
          "text": "Can move up to DOUBLE NEAR distance."
        },
        {
          "name": "Superior Maneuverability",
          "text": "The pilot has advantage on DEX checks for combat and chase maneuvers."
        }
      ],
      "talents": [
        {
          "r": "2",
          "text": "Barrel Roll! 1/episode, ignore all damage from one attack. +1 use if already known."
        },
        {
          "r": "3-6",
          "text": "+1 to HP"
        ...
        {
          "r": "12",
          "text": "Choose a Fighter Talent or +2 points to assign to stats"
        }
      ]
    },
    {
      "name": "Freighter",
      "blurb": "Grunts, haulers, tugs, and barges — the muscle that carries the galaxy on its shoulders.",
      "sysSlots": 6,
      "featSlots": 9,
      "freeComponent": "Cargo Frame/Hold",
      "hpDie": "d8",
      "features": [
        {
          "name": "Space Hauler",
          "text": "Add the ship's STR modifier, if positive, to its cargo slots."
        },
        {
          "name": "Might Not Look Like Much",
          "text": "Advantage on CHA checks when trying to keep a low profile."
        },
        {
          "name": "Structural Resilience",
          "text": "Advantage on STR checks to overcome an opposing force (gravity wells, barriers)."
        }
      ],
      "talents": [
        {
          "r": "2",
          "text": "Sensor Countermeasures. 1/episode, auto-evade scans, sweeps, or targeting locks. +1 use if already known."
        },
        {
          "r": "3-6",
          "text": "+1 to HP"
        ...
        {
          "r": "12",
          "text": "Choose a Freighter Talent or +2 points to assign to stats"
        }
      ]
    },
    {
      "name": "Gunship",
      "blurb": "Destroyers, gunboats, assault craft, and siege platforms — the iron fist of raw firepower.",
      "sysSlots": 9,
      "featSlots": 6,
      "freeComponent": "Light Armor Plating",
      "hpDie": "d8",
      "features": [
        {
          "name": "Regenerative Shields",
          "text": "Repair checks for the ship's shields are DC 10."
        },
        {
          "name": "Targeting Matrix",
          "text": "A targeted ship has DISADV to evade the gunship's missiles and torpedoes."
        },
        {
          "name": "Volley Command System",
          "text": "When all fire-linked weapons target one target, the gunner uses a single attack roll for all (declared before rolling)."
        }
      ],
      "talents": [
        {
          "r": "2",
          "text": "Ablative Plating. 3/episode, take half damage from one attack. +1 use if already known."
        },
        {
          "r": "3-6",
          "text": "+1 to HP"
        ...
        {
          "r": "12",
          "text": "Choose a Gunship Talent or +2 points to assign to stats"
        }
      ]
    },
    {
      "name": "Research",
      "blurb": "Laboratories, observatories, clinics, and survey ships — the patient mind of the galaxy.",
      "sysSlots": 7,
      "featSlots": 8,
      "freeComponent": "Science Station",
      "hpDie": "d4",
      "features": [
        {
          "name": "Deep Analysis Sensors",
          "text": "While the Sensor Array is online, all DCs for analyzing exterior anomalies are reduced by 3."
        },
        {
          "name": "Cosmic Regenerator Array",
          "text": "The ship can Rest when the crew does (Interruption and Danger Level still apply)."
        },
        {
          "name": "Exocraft Bay",
          "text": "Accommodates a smaller vehicle (shuttle, escape pod, drone) or 4 cargo slots."
        }
      ],
      "talents": [
        {
          "r": "2",
          "text": "Scientific Probe. 1/episode, ask the GM one yes/no question via the Science Station or Sensor Array. +1 use if already known."
        },
        {
          "r": "3-6",
          "text": "+1 to HP"
        ...
        {
          "r": "12",
          "text": "Choose a Research Talent or +2 points to assign to stats"
        }
      ]
    },
    {
      "name": "Yacht",
      "blurb": "Couriers, pleasure cruisers, diplomatic barges, and vanity ships — glittering jewels of the void.",
      "sysSlots": 5,
      "featSlots": 10,
      "freeComponent": "Galley",
      "hpDie": "d6",
      "features": [
        {
          "name": "Luxury Design",
          "text": "The crew has advantage on CHA checks aboard the ship."
        },
        {
          "name": "Rich Accommodations",
          "text": "Cost of living expenses are reduced by one category."
        },
        {
          "name": "Shipboard Lounge",
          "text": "Carousing costs are automatically 30cr less when aboard the ship."
        }
      ],
      "talents": [
        {
          "r": "2",
          "text": "Escape Drive. 1/episode, make an immediate escape jump even if the SL/FTL drive is offline (random destination). +1 use if already known."
        },
        {
          "r": "3-6",
          "text": "+1 to HP"
        ...
        {
          "r": "12",
          "text": "Choose a Yacht Talent or +2 points to assign to stats"
        }
      ]
    }
  ],
  "components": [
    {
      "name": "Cargo Frame/Hold",
      "cost": 1000,
      "maint": 500,
      "type": "Feature",
      "advanced": false,
      "desc": "Carries 10 m³ units of bulk cargo."
    },
    {
      "name": "Crew Quarters",
      "cost": 250,
      ...
      "type": "Feature",
      "advanced": false,
      "costNote": "250cr per bunk (up to 4) / 250cr total maint",
      "desc": "Bunks are required to take a Rest aboard the ship."
    },
    {
      ...
      "type": "System",
      "advanced": true,
      "desc": "Communicate over long distances. (Base system.)"
    },
    {
      "name": "FTL Drive",
      "cost": 4000,
      ...
      "type": "System",
      "advanced": true,
      "desc": "Travel at faster-than-light speed."
    },
    {
      "name": "Galley",
      "cost": 500,
      ...
      "type": "Feature",
      "advanced": false,
      "desc": "A stocked kitchen. DC 12 WIS: the crew doesn't use a ration during a Rest."
    },
    {
      "name": "Medical Bay",
      "cost": 700,
      ...
      "type": "Feature",
      "advanced": false,
      "desc": "Medical tasks at advantage. DC 15 INT: an ally regains 1d6 HP."
    },
    {
      "name": "Memory Bank",
      "cost": 1000,
      ...
      "type": "System",
      "advanced": true,
      "desc": "Stores data; comes with a set of star charts. (Base system.)"
    },
    {
      ...
      "type": "System",
      "advanced": true,
      "desc": "Makes astrogation calculations (avoids the +1 category penalty)."
    },
    {
      ...
      "type": "Feature",
      "advanced": true,
      "desc": "Scientific analysis and experimentation; related check DCs reduced by 3."
    },
    {
      "name": "Sensor Array",
      "cost": 1000,
      ...
      "type": "System",
      "advanced": true,
      "desc": "Detect ships and objects up to FAR range."
    },
    {
      ...
      "type": "Feature",
      "advanced": false,
      "desc": "Hides one cargo slot. DC 15 WIS to find it."
    },
    {
      "name": "Sublight Drive",
      "cost": 2000,
      ...
      "type": "System",
      "advanced": true,
      "desc": "Travel at sublight speed. (Base system.)"
    },
    {
      "name": "Passenger Bay",
      "cost": 250,
      ...
      "type": "Feature",
      "advanced": false,
      "costNote": "250cr per person (up to 4) / 500cr total maint",
      "desc": "Seats passengers and stores personal items."
    },
    {
      "name": "Weapons Array",
      "cost": 100,
      ...
      "type": "System",
      "advanced": false,
      "costNote": "100cr + weapons (up to 4) / +100cr per fire-linked weapon",
      "desc": "Houses the ship's weapons. Fire-linked arrays need only one gunner."
    }
  ],
  "weaponProps": {
  ...
  "commandCrew": [
    {
      "role": "Captain",
      "text": "Responsible for and answers for the ship."
    },
    {
      "role": "Pilot",
      "text": "Maneuvers the ship."
    },
    {
      "role": "Co-Pilot",
      "text": "Assists as an additional pilot or gunner."
    },
    {
      "role": "Gunner",
      "text": "Fires a weapon."
    ...
    {
      "role": "Astrogator",
      "text": "Makes astrogation calculations."
    },
    {
      "role": "Chaplain",
      "text": "The ship's spiritual guide, counselor, or negotiator."
    },
    {
      "role": "Cook",
      "text": "Feeds the crew (no living off rations)."
    },
    {
      "role": "Engineer",
      "text": "Maintains and repairs the ship."
    },
    {
      "role": "Ensign",
      "text": "A junior officer who takes on roles as needed."
    },
    {
      "role": "Medic",
      "text": "Responsible for the crew's health."
    },
    {
      "role": "Quartermaster",
      "text": "Manages the cargo and ship accounts."
    },
    {
      "role": "Salvage Engineer",
      "text": "Takes apart damaged and scrapped ships."
    }
  ],
  "weapons": [
    {
