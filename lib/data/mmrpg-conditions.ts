...
import type { MmrpgCondition } from "./mmrpg-types";

export const MMRPG_CONDITIONS = [
  {
    "name": "Ablaze",
    "genre": "core",
    "description": "The character is on fire. At the end of each of their turns they lose 5 Health until the flames are put out. Putting the fire out takes an action and an Agility check against TN 10 — dropping prone to roll or being doused in water makes that easier.",
  ...
  },
  {
    "name": "Bleeding",
    "genre": "core",
    "description": "The character has an open wound and loses 5 Health at the end of each of their turns. The bleeding stops as soon as they recover any Health, or when someone spends an action to stanch it with a Logic check against TN 10.",
    "source": "Lose 5 Health at the end of each turn until stopped (Logic vs TN 10) or you recover any Health."
  },
  {
    "name": "Blinded",
    "genre": "core",
    "description": "The character cannot see. Any concentration power that relies on sight ends, their movement speed is halved, they have trouble on action checks that require sight, and attackers have an edge against them.",
  ...
  },
  {
    "name": "Corroding",
    "genre": "core",
    "description": "If a character is affected by corrosive chemicals—like burning acids—they are corroding. A corroding character loses 5 Health at the end of each of their turns until they die or the condition ends. Being washed with copious amounts of water can remove the corrosive chemical.",
    "source": "X-Men Expansion"
  },
  {
    "name": "Deafened",
    "genre": "core",
    "description": "The character cannot hear. Any concentration power that relies on hearing ends, and they have trouble on action checks that require hearing.",
    "source": "Hearing-based concentration powers end; trouble on action checks that need hearing."
  },
  {
    "name": "Demoralized",
    "genre": "core",
    "description": "The character’s will is broken: their concentration powers end and they have trouble on all action checks. This is the Focus-track equivalent of being knocked out — it happens automatically when Focus drops to 0 and lifts once Focus rises above 0.",
  ...
  },
  {
    "name": "Frightened",
    "genre": "core",
    "description": "The character is struck with fear. They must immediately make an Ego vs. TN 13 action check. If they fail, the fear paralyzes them for one round. If they succeed, they must use their standard action and their movement action to flee from their attacker at their top speed for one round. On a Fantastic success, they are no longer frightened and can act normally, including reacting to whatever it was that caused them to be frightened.",
    "source": "Spider-Verse Expansion"
  },
  {
    "name": "Grabbed",
    "genre": "core",
    "description": "The character is held and cannot move. The grabber cannot move either, unless they are strong enough to drag the character along. The character breaks free with the Escape action — a Melee check against the grabber’s Melee defense.",
  ...
  },
  {
    "name": "Paralyzed",
    "genre": "core",
    "description": "The character is frozen in place. They cannot move and cannot take any action that uses Melee or Agility, and attackers have an edge against them.",
  ...
  },
  {
    "name": "Pinned",
    "genre": "core",
    "description": "A stronger form of Grabbed: the character is held down, cannot take movement actions, and has trouble on Melee and Agility checks until they escape.",
  ...
  },
  {
    "name": "Prone",
    "genre": "core",
    "description": "The character is lying on the ground. They have trouble on their own ranged (Agility) attacks, while enemies attacking them in close combat have an edge. Standing up uses part of their movement.",
  ...
  },
  {
    "name": "Shattered",
    "genre": "core",
    "description": "The character’s mind is broken — a long-term condition beyond a single scene. They cannot adventure effectively and need extended downtime or care to recover.",
    "source": "Mentally broken — requires long-term care."
  },
  {
    "name": "Stunned",
    "genre": "core",
    "description": "The character is dazed. Their concentration powers end; they have trouble on all standard actions and reactions and cannot take movement actions (they can still use powers that work as a standard action or reaction), and attackers have an edge against them. Lasts 1 round. (Updated in the Secret Wars Expansion.)",
    "source": "Trouble on standard actions/reactions; no movement; concentration ends; attackers get an edge (1 round).",
    "mech": {
      "troubleAll": true,
      "noMove": true
    }
  },
  {
    "name": "Surprised",
    "genre": "core",
    "description": "The character was caught off guard at the start of a fight. They cannot act during the surprise (bonus) round, and attackers have an edge against them during it.",
    "source": "Can't act in the bonus round; attackers get an edge on you."
  },
  {
    "name": "Unconscious",
    "genre": "core",
    "description": "The character is knocked out — helpless and unable to act. Their concentration powers end and their defenses drop. This happens automatically when Health reaches 0 and lifts when they regain Health above 0.",
    "source": "Out cold — concentration powers end; helpless and unable to act.",
    "mech": {
      "disableAll": true
    }
  }
] as unknown as MmrpgCondition[];
