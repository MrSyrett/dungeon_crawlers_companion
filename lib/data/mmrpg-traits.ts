...
import type { MmrpgTrait } from "./mmrpg-types";

export const MMRPG_TRAITS = [
  {
    "name": "Abrasive",
    "genre": "core",
  ...
  },
  {
    ...
    "genre": "core",
    "description": "The character can react quickly in combat. This grants them one additional reaction each round."
  },
  {
    "name": "Connections",
    "genre": "core",
  ...
  },
  {
    "name": "Iron Will",
    "genre": "core",
    "description": "Enemies have trouble on attacks to control the character’s mind or influence their behavior. Also, the character gains an edge on checks to break free of mind control or other compulsions."
  },
  {
    "name": "Legal Eagle",
    "genre": "core",
  ...
  },
  {
    "name": "Stranger",
    "genre": "core",
    "description": "The character doesn’t understand local customs. They have trouble on checks made when trying to decipher such things or when trying to pass themselves offas a local."
  },
  {
