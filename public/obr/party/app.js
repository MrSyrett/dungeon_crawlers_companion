/* Party Tokens — Owlbear Rodeo extension logic (plain JS, no bundler).
 *
...
(function () {
  ...
  function boot() {
    if (!OBR || !OBR.isAvailable) {
      document.body.innerHTML = '<p class="sub" style="padding:10px">Open this inside Owlbear Rodeo: add the extension with its manifest URL, then click Party Tokens in a room.</p>';
      return;
    }
    wire();
