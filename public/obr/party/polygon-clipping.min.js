/*! polygon-clipping v0.15.7 — MIT License, Copyright (c) 2018 Mike Fogel
 * https://github.com/mfogel/polygon-clipping (bundles splaytree + robust-predicates, MIT/Unlicense)
 * Vendored as the prebuilt UMD so the Table Tools background page can use it
 * without a bundler. Exposes window.polygonClipping. Rebuild: npm pack polygon-clipping@0.15.7
 * and copy dist/polygon-clipping.umd.min.js.
 */
