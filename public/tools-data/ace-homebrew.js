// GENERATED-STYLE runtime homebrew loader for the ACE system.
// Mirrors dnd-homebrew.js but for pools that are bare `const ACE_*`
...
(function () {
  'use strict';
  var TARGETS = {
    'ace-role': function(){ return typeof ACE_ROLES !== 'undefined' ? ACE_ROLES : null; },
    'ace-gear': function(){ return typeof ACE_GEAR !== 'undefined' ? ACE_GEAR : null; },
    'ace-extra': function(){ return typeof ACE_EXTRAS !== 'undefined' ? ACE_EXTRAS : null; },
    'ace-focus': function(){ return typeof ACE_FOCUSES !== 'undefined' ? ACE_FOCUSES : null; },
    'ace-trait': function(){ return typeof ACE_TRAITS !== 'undefined' ? ACE_TRAITS : null; }
  };
