// Dungeon Crawler Carl RPG quick rules for the character sheet's "? Rules" panel.
// Hand-curated from Rules for Survival (page = printed page). Edit here.
const DCC_QUICK_RULES = [
  {
    title: "Dice & rounding",
