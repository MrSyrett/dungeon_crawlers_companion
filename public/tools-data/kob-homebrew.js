// GENERATED-STYLE runtime homebrew loader for the KOB system.
// Mirrors dnd-homebrew.js but for pools that are bare `const KOB_*`
...
(function () {
  'use strict';
  var TARGETS = {
    'kob-trope': function(){ return typeof KOB_TROPES !== 'undefined' ? KOB_TROPES : null; },
    'kob-strength': function(){ return typeof KOB_STRENGTHS !== 'undefined' ? KOB_STRENGTHS : null; },
    'kob-flaw': function(){ return typeof KOB_FLAWS !== 'undefined' ? KOB_FLAWS : null; }
  };
