...
// The "dcc-*" types are served by the separate DCC homebrew components, never this
// SD manager, but the union must stay wide enough to accept the shared HomebrewRecord
// the pages pass.
type HbType =
