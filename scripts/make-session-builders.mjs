// Generates the ACE!, Kids on Bikes, Nimble and Star Wars Adventure Prep Builders from the
...
const SYSTEMS = [
  {
    ...
    name: "ACE!", title: "Adventure Prep Builder — ACE! (Awfully Cheerful Engine)",
  ...
  },
  {
    ...
    name: "Kids on Bikes", title: "Adventure Prep Builder — Kids on Bikes",
  ...
  },
  {
    ...
    name: "Nimble", title: "Adventure Prep Builder — Nimble",
  ...
  },
  {
    ...
    name: "Star Wars", title: "Adventure Prep Builder — Star Wars: The Roleplaying Game",
...
for (const S of SYSTEMS) {
  let s = base;
  s = rep(s, "<title>Adventure Prep Builder — Dungeon Crawler Carl RPG</title>", `<title>${S.title}</title>`);
  s = s.replace(/<!-- BUILD: [^>]*-->/, `<!-- BUILD: ${S.name} Adventure Prep Builder (generated from the DCC builder) -->`);
  s = s.replace(/window\.__BUILD__="[^"]*"/, `window.__BUILD__="${S.name} Adventure Prep Builder"`);
  // palette
